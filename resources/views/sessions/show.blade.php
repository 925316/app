            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex justify-between items-start mb-6">
                        <div>
                            <h3 class="text-2xl font-bold mb-2">Session #{{ $session->id }}</h3>
                            <div class="flex items-center space-x-2">
                                @if ($session->isActive())
                                    <span
                                ...
                                <span
                                    ...
                                    Client: {{ $session->client_version ?? 'Unknown' }}
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                            <h4 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Basic Information</h4>
                            <dl class="space-y-3">
                                <div>
                                ...
                                <div>
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Client Version</dt>
                        ...
                        <!-- Timing Information -->
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                            <h4 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Timing Information</h4>
                            <dl class="space-y-3">
                                <div>
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Created At</dt>
                                    <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                                        {{ $session->created_at ? $session->created_at->format('Y-m-d H:i:s') : 'Unknown' }}
                                ...
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                                        {{ $session->updated_at ? $session->updated_at->format('Y-m-d H:i:s') : 'Unknown' }}
                                ...
                                <div>
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Last Heartbeat</dt>
                                    <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                                ...
                                <div>
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Session Age</dt>
                                    <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                                        @if ($session->age_in_minutes !== null)
                                            {{ number_format($session->age_in_minutes, 2) }} minutes
                                        @else
                                            Unknown
                                        @endif
                                    </dd>
                    ...
                    @if ($session->account)
                        <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 mb-6">
                            <h4 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Related Account</h4>
                    ...
                    @else
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 mb-6">
                            <h4 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Related Account</h4>
                            <p class="text-sm text-gray-500 dark:text-gray-400">No account associated with this session.
                                This may indicate a deleted account.</p>
                        </div>
                    @endif
                    ...
                    @if ($session->device)
                        <div class="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-6 mb-6">
                            <h4 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Related Device</h4>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-12 w-12">
                                        <div
                                    ...
                                    <div class="ml-4">
                                        ...
                                        @if ($session->device->bound_at)
                                            <div class="text-sm text-gray-500 dark:text-gray-400">
                                                Bound since: {{ $session->device->bound_at->format('Y-m-d H:i:s') }}
                                            </div>
                                        @endif
                                    </div>
                                </div>
                    ...
                    @else
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 mb-6">
                            <h4 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Related Device</h4>
                            <p class="text-sm text-gray-500 dark:text-gray-400">No device associated with this session.
                                This may indicate a deleted device or an unbound session.</p>
                        </div>
                    @endif
