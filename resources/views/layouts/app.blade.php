...
<body class="app-shell-page shell-atelier shell-atelier--topnav font-sans antialiased min-h-screen transition-colors duration-300"
    data-shell-theme="atelier" data-shell-variant="topnav">
