  <aside x-data
    ...
    <div class="relative flex items-center justify-between h-16 px-4 border-b border-cool-200/50 dark:border-cool-700/50">
        <!-- Logo Container -->
        <div class="flex items-center space-x-3" :class="{ 'opacity-0 w-0': !$store.sidebar.open, 'opacity-100 w-auto': $store.sidebar.open }">
        ...
        <button @click="$store.sidebar.toggle()"
            ...
            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path :class="{ 'hidden': !$store.sidebar.open, 'inline-flex': $store.sidebar.open }" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 19l-7-7 7-7m8 14l-7-7 7-7" />
                <path :class="{ 'hidden': $store.sidebar.open, 'inline-flex': !$store.sidebar.open }" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 5l7 7-7 7M5 5l7 7-7 7" />
            </svg>
        </button>
    </div>
