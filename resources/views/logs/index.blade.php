            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                        ...
                        <button onclick="showClearModal()" class="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition">
                            Clear Old Logs
                        </button>
                    </div>
                    ...
                    <div class="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        <form method="GET" action="{{ route('logs.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                            <div>
                                <label for="event_type" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Event Type</label>
                                <select name="event_type" id="event_type" class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300">
                            ...
                            <div>
                                <label for="event_level" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Event Level</label>
                                <select name="event_level" id="event_level" class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300">
                            ...
                            <div class="flex gap-2">
                                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition mt-auto">
                                    Filter
                                </button>
                                <a href="{{ route('logs.index') }}" class="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition mt-auto">
                                    Reset
                                </a>
                            </div>
                        </form>
                        ...
                        <!-- Date Range Filter -->
                        <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-600 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
    ...
    <div id="clearModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg max-w-md w-full mx-4">
            ...
            <form action="{{ route('logs.clear') }}" method="POST">
                @csrf
                <div class="mb-4">
                    <label for="days" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Delete logs older than</label>
                ...
                <div class="flex justify-end gap-2">
                    <button type="button" onclick="hideClearModal()" class="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition">
                        Cancel
                    </button>
