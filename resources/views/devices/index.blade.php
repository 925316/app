        ...
        <div class="w-full">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-xl">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @if ($currentDevice)
                        <div
                            class="mb-6 p-4 bg-gradient-to-r from-zinc-50 to-zinc-100 dark:from-zinc-900/50 dark:to-zinc-800/50 rounded-xl border border-zinc-200/50 dark:border-zinc-700/50">
                            <div class="flex items-center justify-between flex-wrap gap-4">
                                <div class="flex items-center gap-4">
                                    <div class="p-3 bg-zinc-500/20 rounded-full">
                                        <svg class="w-6 h-6 text-zinc-600 dark:text-zinc-300" fill="none"
                                    ...
                                    <div>
                                        <h4 class="font-medium text-zinc-800 dark:text-zinc-200">{{ __('Currently Bound Device') }}</h4>
                    ...
                    @else
                        <div
                            class="mb-6 p-4 bg-gradient-to-r from-yellow-50 to-yellow-100 dark:from-yellow-900/50 dark:to-yellow-800/50 rounded-xl border border-yellow-200/50 dark:border-yellow-700/50">
                            <div class="flex items-center gap-4">
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2 whitespace-nowrap text-sm">
                                    @if ($device->bound_at && !$device->unbound_at)
                                        <span class="px-2 py-0.5 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded-lg text-xs font-medium">
                                            {{ __('Currently Bound') }}
                                        </span>
                                    @else
                                        <span class="px-2 py-0.5 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg text-xs font-medium">
                                            {{ __('Historical') }}
                                        </span>
                                    @endif
                                </td>
