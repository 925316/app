        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">       
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @else
                        <div class="mb-6 p-4 bg-gradient-to-r from-yellow-50 to-yellow-100 dark:from-yellow-900/50 dark:to-yellow-800/50 rounded-lg border border-yellow-200/50 dark:border-yellow-700/50">
                            <div class="flex items-center gap-4">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2 whitespace-nowrap text-sm">
                                        <div class="flex gap-2">
                                            @if($device->isBound())
                                                <form method="POST"
                                                      action="{{ route('devices.unbind', $device) }}"
                                                      class="inline"
