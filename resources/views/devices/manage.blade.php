        ...
        @if(!$currentDevice)
            <div class="mb-4">
                ...
                <form method="POST" action="{{ route('devices.bind') }}">
                    ...
                    <div class="mb-3">
                        <label for="hwid_hash" class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">HWID
                            Hash</label>
                    ...
                    <div class="mb-3">
                        <label for="ip_address" class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">IP
                            Address</label>
