                        ...
                        <form method="GET" action="{{ route('devices.index') }}"
                            ...
                            <div>
                                ...
                                <select name="date_range" id="date_range"
                                    ...
                                    <option value="24h" {{ request('date_range') === '24h' ? 'selected' : '' }}>Last 24
                                        Hours
                                    </option>
                                    <option value="7d" {{ request('date_range') === '7d' ? 'selected' : '' }}>Last 7
                                        Days
                                    </option>
                                    <option value="30d" {{ request('date_range') === '30d' ? 'selected' : '' }}>Last 30
                                        Days
                                    </option>
                                    <option value="90d" {{ request('date_range') === '90d' ? 'selected' : '' }}>Last 90
                                        Days
                                    </option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="account_status" id="account_status"
                                    ...
                                    <option value="">All</option>
                                    <option
                                        value="active" {{ request('account_status') === 'active' ? 'selected' : '' }}>
                                        Active
                                    </option>
                                    <option
                                        value="suspended" {{ request('account_status') === 'suspended' ? 'selected' : '' }}>
                                        Suspended
                                    </option>
                                </select>
                            </div>
                            ...
                            @forelse($devices as $device)
                                <tr>
                                    <td class="px-4 py-2 whitespace-nowrap text-sm">
                                        <div
                                            class="font-medium text-gray-900 dark:text-gray-100">{{ $device->account->username }}</div>
                                        <div
                                            class="text-xs text-gray-500 dark:text-gray-400">{{ $device->account->email }}</div>
                                    </td>
                                    ...
                                    <td class="px-4 py-2 whitespace-nowrap text-sm">
                                        ...
                                        <div
                                            class="text-xs text-gray-500 dark:text-gray-400">{{ $device->country_code ?? 'Unknown' }}</div>
                                    </td>
                                    <td class="px-4 py-2 whitespace-nowrap text-sm">
