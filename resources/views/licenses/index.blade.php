    ...
    <div class="space-y-6">
            ...
            <div class="card-shell overflow-hidden">
                <div class="p-6 text-gray-900 dark:text-gray-100 space-y-6">
                    ...
                    <div class="app-toolbar">
                        ...
                        @if ($isAdmin ?? false)
                            <div class="app-toolbar-actions">
                                <a href="{{ route('licenses.create') }}" class="btn btn-secondary btn-sm">
                                    {{ __('Create License') }}
                                </a>
                            </div>
                        @endif
                    ...
                    @if (!$isAdmin ?? false)
                        <div class="card-shell-muted border border-zinc-200/60 dark:border-zinc-700 bg-zinc-50/70 dark:bg-zinc-900">
                            <div class="flex items-start space-x-4">
                                <div class="p-3 bg-zinc-500/20 rounded-full">
                                    <svg class="w-6 h-6 text-zinc-700 dark:text-zinc-200" fill="none"
                                ...
                                <div class="flex-1">
                                    ...
                                    <h4 class="text-lg font-semibold text-gray-800 dark:text-zinc-100 mb-2">{{ __('Activate License') }}</h4>
                                    ...
                                    <form method="POST" action="{{ route('licenses.activate-by-key') }}" class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" id="license_key" name="license_key"
                                                ...
                                                class="form-input form-pill px-4 py-3 text-center font-mono text-lg tracking-wider uppercase @error('license_key') border-red-500 @enderror"
                                        ...
                                        <div class="rounded-xl border border-zinc-200/70 bg-white/70 px-4 py-3 text-sm text-gray-600 dark:border-zinc-700 dark:bg-zinc-800 dark:text-gray-300">
                        ...
                        <x-filter-box :action="route('licenses.index')" :showTotal="true" :totalCount="$licenses->total()">
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select name="status" id="status" class="form-select form-pill form-select-enhanced py-2">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select name="privilege" id="privilege" class="form-select form-pill form-select-enhanced py-2">
                                    ...
                                    <div class="flex gap-2">
                                        <div class="relative flex-1">
                                            ...
                                            <input type="text" name="search" id="search"
                                                ...
                                                class="form-input form-pill pl-10 pr-4 py-2"
                                ...
                                <div class="mt-4 flex items-center space-x-3">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        @if (request()->filled('status'))
                                            ...
                                            @endphp
                                            @if ($statusLabel)
                                                <x-filter-badge :label="__('Status:').' '.ucfirst($statusLabel)" color="gray"
                        ...
                        @forelse($licenses as $license)
                            <tr>
                                ...
                                <td class="px-4 py-2 whitespace-nowrap text-sm">
                                    <span class="px-2 py-0.5 rounded-lg text-xs font-medium {{ $license->getStatusColorAttribute() }}">
