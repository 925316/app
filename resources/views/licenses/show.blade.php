    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">{{ __('License:') }} {{ $license->key }}</h3>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                ...
                <div class="space-y-2 text-sm">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium text-gray-900 dark:text-white">{{ $license->created_from_ip ?? __('N/A') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                ...
                <div class="space-y-2 text-sm">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span
                            class="font-medium text-gray-900 dark:text-white">{{ $license->activated_at?->format('Y-m-d H:i:s') ?? __('Not activated') }}</span>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span
                            class="font-medium text-gray-900 dark:text-white">{{ $license->suspended_at?->format('Y-m-d H:i:s') ?? __('Never') }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600 dark:text-gray-300">{{ __('Days Until Expiry:') }}</span>
                        <span class="font-medium text-gray-900 dark:text-white">{{ $license->daysUntilExpiry() }} {{ __('days') }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <div class="space-y-3 text-sm">
                    ...
                    <div class="flex justify-between">
                        <span class="text-gray-600 dark:text-gray-300">{{ __('Activated At:') }}</span>
                        <span
                            class="font-medium text-gray-900 dark:text-white">{{ $statusHistory['activated_at']?->format('Y-m-d H:i:s') ?? __('Not activated') }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600 dark:text-gray-300">{{ __('Suspended At:') }}</span>
                        <span
                            class="font-medium text-gray-900 dark:text-white">{{ $statusHistory['suspended_at']?->format('Y-m-d H:i:s') ?? __('Never') }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600 dark:text-gray-300">{{ __('Expires At:') }}</span>
                    ...
                    <div class="flex justify-between">
                        <span class="text-gray-600 dark:text-gray-300">{{ __('Days Until Expiry:') }}</span>
                        <span class="font-medium text-gray-900 dark:text-white">{{ $statusHistory['days_until_expiry'] }} {{ __('days') }}</span>
                    </div>
                </div>
            </div>
        </div>
