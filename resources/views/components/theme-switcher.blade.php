...
@once
    <x-dropmenu :modular="$modular" icon_right="{{$iconRight}}">
        <x-slot:trigger>
            <x-icon
                    name="{{$lightIcon}}"
                    type="{{$iconType}}"
        ...
        <x-dropmenu.item onclick="chooseTheme('light')" icon="{{$lightIcon}}" icon_css="stroke-2">
            {{$lightText}}
        </x-dropmenu.item>
        <x-dropmenu.item onclick="chooseTheme('dark')" icon="{{$darkIcon}}" icon_css="stroke-2">
            {{$darkText}}
        </x-dropmenu.item>
        <x-dropmenu.item onclick="chooseTheme('system')" icon="{{$systemIcon}}" icon_css="stroke-2">
            {{$systemText}}
        </x-dropmenu.item>
    </x-dropmenu>
