...
@props([
    ...
    'errorHeading' => config('bladewind.checkcards.error_heading', __('bladewind.checkcard_error_heading')),
    'errorMessage' => config('bladewind.checkcards.error_message', __('bladewind.checkcard_error_message')),
    'selectedValue' => '',
...
<div class="checkcards-{{$name}} {{$class}}">
    <x-input
            :name="$name"
