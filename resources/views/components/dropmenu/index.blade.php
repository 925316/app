{{-- format-ignore-start --}}
@props([
    'name' => defaultBladewindName('dropmenu-'),
...
<div class="relative inline-block leading-none text-left dropmenu !z-20 {{$name}}" tabindex="0">
    <div class="trigger cursor-pointer inline-block">
    ...
    <div class="opacity-0 hidden dropmenu-items !z-20 animate__animated animate__fadeIn animate__faster"
         data-open="0">
        <div @class([
                'absolute bg-white dark:bg-dark-700 mt-1 rounded-md',
                'border border-transparent dark:border-dark-800/20 items-list ring-1 ring-slate-800 ring-opacity-5',
...
<x-script :nonce="$nonce">
    @php include_once(public_path('resources/js/modules/dropmenu.js')); @endphp
</x-script>
