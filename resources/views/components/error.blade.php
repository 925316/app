{{-- format-ignore-start --}}
@props([
    'heading' => __('bladewind.error_heading'),
    'description' => __('bladewind.error_description'),
    'buttonText' => __('bladewind.error_button_text'),
    'buttonUrl' => '/',
    'image' => '',
])
<div class="flex justify-center items-center">
    <div class="max-w-xl px-8">
        ...
        <div class="text-center pt-2">
            <a href="{{ $buttonUrl }}">
                <x-button type="primary" size="small">{{ $buttonText }}</x-button>
            </a>
        </div>
    </div>
</div>