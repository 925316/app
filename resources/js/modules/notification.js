class Notification {
    ...
    show = () => {
        ...
        domEl(".notification-container").insertAdjacentHTML(
            "beforeend",
            this.template(),
        );
    ...
    modalIcon = () => {
        ...
        changeCss(`.notification-icons .${this.type}`, "hidden", "remove");
        return domEl(`.notification-icons .${this.type}`).outerHTML.replaceAll(
            "[type]",
            this.typeColour(this.type),
        );
    };
